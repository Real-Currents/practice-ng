/**
 * @license AngularJS v1.2.28-local+sha.7e5be5f
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.28-local+sha.7e5be5f/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.28-local+sha.7e5be5f',    // all of these placeholder strings will be replaced by grunt's
